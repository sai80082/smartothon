            ...
            <div class="max-w-[330px] w-full shadow-lg rounded-2xl ">
                <div class="md:p-8 p-5 dark:bg-gray-800 bg-whtie rounded-t rounded-2xl">
                    <div class="px-4 flex items-center justify-between">
                        <span tabindex="0" class="focus:outline-none  text-base font-bold dark:text-gray-100 text-gray-800">June 2023</span>
                    </div>
                    <div class="flex items-center justify-between overflow-x-hidden">
                        <table class="w-full ">
                            ...
                            <tbody>
                                <tr>
                                    <td class="">
                                        <div class="px-2  cursor-pointer flex w-full justify-center"></div>
                                    </td>
                                    <td class="">
                                        <div class="px-2  cursor-pointer flex w-full justify-center"></div>
                                    </td>
                                    ...
                                    <td class="">
                                        <div class="px-2  cursor-pointer flex w-full justify-center">
